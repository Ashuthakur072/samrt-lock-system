...
% TestImage = strcat('C:\Users\tashi\Documents\MATLAB\Face-Recognition-master\TestDatabase\');
...
output = Recognition(TestImage, m, A, Eigenfaces);
if (output == 1)
